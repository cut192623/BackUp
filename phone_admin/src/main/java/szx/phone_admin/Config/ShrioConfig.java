package szx.phone_admin.Config;
...
import szx.phone_admin.Realm.UserRealm;

import java.util.LinkedHashMap;
import java.util.Map;

/*
* configuration用于定义配置类，该类的各个方法返回各种对象，实现系统的配置
* */
@Configuration
...
//        创建一个匹配器
        ...
        matcher.setStoredCredentialsHexEncoded(true);//设置密文是16进制编码 base64编码
        return matcher;
    }
    ...
    public UserRealm Realm(){
        ...
        Realm.setCredentialsMatcher(hashedCredentialsMatcher());//设置密码匹配器
        Realm.setCachingEnabled(false);//取消缓存
        return Realm;
    }
    ...
    public SecurityManager securityManager(){
        ...
        securityManager.setRealm(Realm());          //设置Realm数据
